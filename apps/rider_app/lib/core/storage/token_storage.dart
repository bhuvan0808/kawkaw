...
class TokenStorage {
  ...
  static const _kAccess = 'kk_rider_access';
  static const _kRefresh = 'kk_rider_refresh';
  ...
  Future<String?> get accessToken async => _cachedAccess ??= await _storage.read(key: _kAccess);
