...
/// Builds the configured Dio instance with bearer-token attachment and
...
class _AuthRefreshInterceptor extends Interceptor {
  ...
  Future<bool> _refreshToken() async {
    ...
    try {
      ...
      final res = await _refreshDio.post<dynamic>(ApiEndpoints.refresh, data: {'refreshToken': refresh});
