...
abstract final class AppConfig {
  ...
  /// Socket.IO endpoint (namespace appended by the client).
  ...
  static const String osmUserAgent = 'in.kawkaw.customer';

  /// Launch city centre (Bhadrachalam, Telangana) used as the map default.
  static const LatLng launchCityCenter = LatLng(17.6688, 80.8936);

  static const String supportPhone = '+910000000000';
  static const String supportEmail = 'support@kawkaw.in';
